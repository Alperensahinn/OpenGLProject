...
DefaultCube::DefaultCube(std::string ID, GLFWwindow* window) 
	: GameObject(ID, window), Drawable("Resources/Cube_2x2x2m.glb", "Resources/stone_wall_diff_2k.jpg", "Resources/WoodenPlanks_Specular.png", "Resources/stone_wall_nor_gl_2k.jpg")
{
